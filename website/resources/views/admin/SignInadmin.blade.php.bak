...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Inter:wght@300;400;500;700&display=swap" rel="stylesheet">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 bg-white">
        ...
        <div class="w-full max-w-md flex flex-col gap-8">
            ...
            <form class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" placeholder="counsel@firm.com" class="w-full pl-12 pr-4 py-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl text-sm text-[#1A1A1A] placeholder-[#8B95A5] focus:outline-none focus:ring-2 focus:ring-[#1D5083]/20 focus:border-[#1D5083] transition-all" required>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" placeholder="••••••••" class="w-full pl-12 pr-12 py-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl text-sm text-[#1A1A1A] placeholder-[#8B95A5] focus:outline-none focus:ring-2 focus:ring-[#1D5083]/20 focus:border-[#1D5083] transition-all" required>
            ...
            <div class="text-center text-sm">
                ...
                <a href="#" class="text-[#1D5083] font-bold hover:text-[#153c63] transition-colors">Request Firm Access</a>
            </div>
